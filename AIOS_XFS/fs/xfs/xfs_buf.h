...
#ifdef CONFIG_AIOS
extern void xfs_AIOS_buf_lock(xfs_buf_t *);
#endif
...
#ifdef CONFIG_AIOS
extern int __xfs_AIOS_buf_submit(struct xfs_buf *bp, bool);
static inline int xfs_AIOS_buf_submit(struct xfs_buf *bp)
{
	bool wait = bp->b_flags & XBF_ASYNC ? false : true;
	return __xfs_AIOS_buf_submit(bp, wait);
}
#endif
