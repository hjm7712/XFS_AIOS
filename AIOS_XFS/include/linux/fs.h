...
#ifdef CONFIG_AIOS
	int (*AIOS_writepage)(struct page *page, struct writeback_control *wbc);
	int (*AIOS_writepages)(struct address_space *, struct writeback_control *);
#endif
...
extern int __must_check file_write_range(struct file *file,
						loff_t start, loff_t end);
#ifdef CONFIG_AIOS
extern int __must_check AIOS_file_write_range(struct file *file,
						loff_t start, loff_t end);
#endif
